...
INSERT INTO Commande (idClient, idPaiement, dateCommande, fraisLivraison, adrLivraison, codePostalLivraison, statutCommande) VALUES
  (1, 1, STR_TO_DATE('2020-Jan-01', '%Y-%m-%d'), 5.99, '1 Rue des Fleurs', 13001, 'En cours de préparation'),
  (4, 1, STR_TO_DATE('2022-Apr-23', '%Y-%m-%d'), 7.99, '10 Rue des Fleurs', 31000, 'En cours de livraison'),
  (34, 1, STR_TO_DATE('2023-May-15', '%Y-%m-%d'), 2.99, '23 Rue des Fleurs', 31700, 'Livrée'),
  (12, 1, STR_TO_DATE('2021-Feb-12', '%Y-%m-%d'), 6.99, '5 Rue des Roses', 75002, 'En cours de préparation'),
  (25, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '8 Rue des Tulipes', 69001, 'En cours de livraison'),
  (7, 1, STR_TO_DATE('2022-Jul-19', '%Y-%m-%d'), 3.99, '15 Rue des Lys', 54000, 'En attente de paiement'),
  (18, 1, STR_TO_DATE('2022-Aug-30', '%Y-%m-%d'), 8.99, '22 Rue des Orchidées', 67000, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2023-Apr-10', '%Y-%m-%d'), 7.99, '12 Rue des Pivoines', 13007, 'En attente de livraison'),
  (6, 1, STR_TO_DATE('2023-Jun-25', '%Y-%m-%d'), 5.99, '30 Rue des Marguerites', 59000, 'Livrée'),
  (29, 1, STR_TO_DATE('2023-Sep-14', '%Y-%m-%d'), 4.99, '18 Rue des Violettes', 33000, 'En cours de préparation'),
  (14, 1, STR_TO_DATE('2023-Nov-02', '%Y-%m-%d'), 6.99, '7 Rue des Iris', 69002, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2023-Dec-18', '%Y-%m-%d'), 3.99, '25 Rue des Camélias', 75012, 'En attente de paiement'),
  (19, 1, STR_TO_DATE('2020-May-20', '%Y-%m-%d'), 7.99, '14 Rue des Glycines', 44000, 'En cours de préparation'),
  (10, 1, STR_TO_DATE('2020-Jul-08', '%Y-%m-%d'), 5.99, '9 Rue des Lys', 13005, 'En cours de livraison'),
  (27, 1, STR_TO_DATE('2021-Sep-12', '%Y-%m-%d'), 6.99, '11 Rue des Roses', 69003, 'En cours de préparation'),
  (3, 1, STR_TO_DATE('2022-Jan-30', '%Y-%m-%d'), 8.99, '20 Rue des Orchidées', 75008, 'En attente de paiement'),
  (35, 1, STR_TO_DATE('2022-Mar-18', '%Y-%m-%d'), 4.99, '17 Rue des Violettes', 31700, 'En cours de livraison'),
  (22, 1, STR_TO_DATE('2022-May-05', '%Y-%m-%d'), 7.99, '28 Rue des Tulipes', 33000, 'Livrée'),
  (13, 1, STR_TO_DATE('2023-Jan-14', '%Y-%m-%d'), 3.99, '6 Rue des Marguerites', 13006, 'En cours de préparation'),
  (5, 1, STR_TO_DATE('2023-Mar-27', '%Y-%m-%d'), 6.99, '3 Rue des Camélias', 54000, 'En cours de livraison'),
  (31, 1, STR_TO_DATE('2023-Jun-10', '%Y-%m-%d'), 5.99, '16 Rue des Pivoines', 59000, 'En attente de paiement'),
  (42, 1, STR_TO_DATE('2023-Aug-22', '%Y-%m-%d'), 4.99, '24 Rue des Iris', 69004, 'Livrée'),
  (8, 1, STR_TO_DATE('2020-Oct-15', '%Y-%m-%d'), 6.99, '5 Rue des Jonquilles', 13009, 'En cours de préparation'),
  (29, 1, STR_TO_DATE('2021-Feb-28', '%Y-%m-%d'), 8.99, '18 Rue des Chrysanthèmes', 75012, 'En cours de livraison'),
  (17, 1, STR_TO_DATE('2021-Apr-10', '%Y-%m-%d'), 4.99, '12 Rue des Lys', 69002, 'Livrée'),
  (7, 1, STR_TO_DATE('2021-Jun-25', '%Y-%m-%d'), 7.99, '8 Rue des Roses', 33001, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2022-Feb-11', '%Y-%m-%d'), 5.99, '15 Rue des Tulipes', 13007, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2022-Apr-30', '%Y-%m-%d'), 3.99, '21 Rue des Orchidées', 59001, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2022-Jul-17', '%Y-%m-%d'), 6.99, '7 Rue des Marguerites', 69003, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2023-Feb-28', '%Y-%m-%d'), 8.99, '2 Rue des Camélias', 31700, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2023-Apr-12', '%Y-%m-%d'), 4.99, '19 Rue des Pivoines', 13008, 'En attente de paiement'),
  (41, 1, STR_TO_DATE('2023-Jul-25', '%Y-%m-%d'), 7.99, '23 Rue des Iris', 69004, 'Livrée'),
  (7, 1, STR_TO_DATE('2020-Nov-15', '%Y-%m-%d'), 5.99, '45 Rue de la Liberté', 75001, 'En cours de préparation'),
  (22, 1, STR_TO_DATE('2021-Mar-28', '%Y-%m-%d'), 7.99, '18 Rue du Commerce', 69002, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 3.99, '30 Avenue des Champs-Élysées', 33000, 'Livrée'),
  (27, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 6.99, '8 Place de la Bastille', 59000, 'En cours de préparation'),
  (8, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '5 Boulevard Saint-Michel', 13005, 'En cours de livraison'),
  (33, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '12 Quai des Grands Augustins', 31000, 'En attente de paiement'),
  (18, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '22 Rue de la République', 69003, 'En cours de préparation'),
  (42, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '14 Rue du Faubourg Saint-Antoine', 75012, 'En cours de livraison'),
  (15, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '25 Quai des Chartrons', 33001, 'Livrée'),
  (38, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '10 Avenue de la Grande Armée', 59001, 'En attente de paiement'),
  (9, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '7 Rue de la République', 13006, 'En cours de préparation'),
  (31, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '16 Rue de la Liberté', 69004, 'En cours de livraison'),
  (19, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '14 Rue du Commerce', 33000, 'Livrée'),
  (10, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '9 Avenue des Champs-Élysées', 54000, 'En cours de préparation'),
  (27, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '11 Place de la Bastille', 75001, 'En cours de livraison'),
  (3, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '20 Boulevard Saint-Michel', 13007, 'En attente de paiement'),
  (35, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '17 Quai des Grands Augustins', 69005, 'En cours de préparation'),
  (22, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '28 Rue de la République', 33001, 'En cours de livraison'),
  (13, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '6 Quai des Chartrons', 13008, 'Livrée'),
  (5, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '3 Avenue de la Grande Armée', 59001, 'En attente de paiement'),
  (31, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '16 Rue de la République', 13009, 'En cours de préparation'),
  (42, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '24 Quai des Chartrons', 69004, 'En cours de livraison'),
  (8, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '5 Avenue de la Grande Armée', 33000, 'Livrée'),
  (29, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '18 Rue de la République', 54000, 'En cours de préparation'),
  (17, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '12 Quai des Chartrons', 75001, 'En cours de livraison'),
  (7, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '8 Avenue de la Grande Armée', 13005, 'En attente de paiement'),
  (24, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '15 Rue de la République', 69006, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '21 Quai des Chartrons', 33001, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '7 Avenue de la Grande Armée', 59001, 'Livrée'),
  (2, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '2 Rue de la République', 13010, 'En attente de paiement'),
  (26, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '19 Quai des Chartrons', 69004, 'En cours de préparation'),
  (41, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '23 Avenue de la Grande Armée', 33000, 'En cours de livraison'),
  (7, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '15 Rue de la République', 54000, 'Livrée'),
  (24, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '30 Quai des Chartrons', 13011, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '25 Avenue de la Grande Armée', 75001, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '7 Rue de la République', 69007, 'En attente de paiement'),
  (2, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '2 Quai des Chartrons', 33001, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '19 Avenue de la Grande Armée', 59001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '23 Rue de la République', 13012, 'Livrée'),
  (7, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '15 Quai des Chartrons', 69004, 'En attente de paiement'),
  (24, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '30 Avenue de la Grande Armée', 31700, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '25 Rue de la République', 54000, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '7 Quai des Chartrons', 13013, 'Livrée'),
  (2, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '2 Avenue de la Grande Armée', 75001, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '19 Rue de la République', 33001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '23 Quai des Chartrons', 59001, 'En attente de paiement'),
  (7, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '15 Avenue de la Grande Armée', 13014, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '30 Rue de la République', 69004, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '25 Quai des Chartrons', 33001, 'Livrée'),
  (12, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '7 Avenue de la Grande Armée', 54000, 'En attente de paiement'),
  (2, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '2 Rue de la République', 13015, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '19 Quai des Chartrons', 75001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '23 Avenue de la Grande Armée', 33000, 'Livrée'),
  (7, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '15 Rue de la République', 13016, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '30 Quai des Chartrons', 69004, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '25 Avenue de la Grande Armée', 54000, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '7 Rue de la République', 13017, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '2 Quai des Chartrons', 33001, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '19 Avenue de la Grande Armée', 59001, 'Livrée'),
  (41, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '23 Rue de la République', 13018, 'En attente de paiement'),
  (7, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '15 Quai des Chartrons', 69004, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2021-Mar-05', '%Y-%m-%d'), 4.99, '30 Avenue de la Grande Armée', 54000, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2021-May-18', '%Y-%m-%d'), 7.99, '25 Rue de la République', 13019, 'Livrée'),
  (12, 1, STR_TO_DATE('2021-Aug-02', '%Y-%m-%d'), 5.99, '7 Quai des Chartrons', 33000, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2022-Feb-15', '%Y-%m-%d'), 8.99, '2 Avenue de la Grande Armée', 59001, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2022-Jul-01', '%Y-%m-%d'), 4.99, '19 Rue de la République', 13020, 'En attente de paiement'),
  (41, 1, STR_TO_DATE('2022-Oct-18', '%Y-%m-%d'), 7.99, '23 Quai des Chartrons', 69004, 'En cours de préparation'),
  (7, 1, STR_TO_DATE('2023-Apr-05', '%Y-%m-%d'), 5.99, '15 Avenue de la Grande Armée', 54000, 'En cours de livraison'),
  (24, 1, STR_TO_DATE('2023-Jun-22', '%Y-%m-%d'), 3.99, '30 Rue de la République', 33001, 'Livrée'),
  (38, 1, STR_TO_DATE('2023-Sep-08', '%Y-%m-%d'), 6.99, '25 Quai des Chartrons', 13021, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2020-Dec-20', '%Y-%m-%d'), 8.99, '7 Avenue de la Grande Armée', 69004, 'En cours de préparation');
