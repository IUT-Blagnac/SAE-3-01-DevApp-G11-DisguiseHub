...
public class DisguiseHubApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(DisguiseHubAppController.class.getResource("DisguiseHubApp.fxml"));
            BorderPane root = loader.load();

            // Paramétrage du Stage : feuille de style, titre
            Scene scene = new Scene(root, root.getPrefWidth() + 20, root.getPrefHeight() + 10);
            scene.getStylesheets().add(DisguiseHubApp.class.getResource("../styles/accueil.css").toExternalForm());

            primaryStage.setScene(scene);
            primaryStage.setTitle("CaptOS - Menu principal");
