...
INSERT INTO Commande (idClient, idPaiement, dateCommande, fraisLivraison, adrLivraison, villeLivraison, paysCommande, codePostalLivraison, statutCommande) VALUES
  (1, 1, STR_TO_DATE('2020-01-01', '%Y-%m-%d'), 5.99, '1 Rue des Fleurs', 'Paris', 'France', 75001, 'En cours de préparation'),
  (4, 1, STR_TO_DATE('2022-03-23', '%Y-%m-%d'), 7.99, '10 Rue des Fleurs', 'Toulouse', 'France', 31000, 'En cours de livraison'),
  (34, 1, STR_TO_DATE('2023-05-15', '%Y-%m-%d'), 2.99, '23 Rue des Fleurs', 'Toulouse', 'France', 31700, 'Livrée'),
  (12, 1, STR_TO_DATE('2021-02-12', '%Y-%m-%d'), 6.99, '5 Rue des Roses', 'Paris', 'France', 75002, 'En cours de préparation'),
  (25, 1, STR_TO_DATE('2021-03-05', '%Y-%m-%d'), 4.99, '8 Rue des Tulipes', 'Lyon', 'France', 69001, 'En cours de livraison'),
  (7, 1, STR_TO_DATE('2022-07-19', '%Y-%m-%d'), 3.99, '15 Rue des Lys', 'Nantes', 'France', 54000, 'En attente de paiement'),
  (18, 1, STR_TO_DATE('2022-08-30', '%Y-%m-%d'), 8.99, '22 Rue des Orchidées', 'Strasbourg', 'France', 67000, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2023-03-10', '%Y-%m-%d'), 7.99, '12 Rue des Pivoines', 'Marseille', 'France', 13007, 'En attente de livraison'),
  (6, 1, STR_TO_DATE('2023-06-25', '%Y-%m-%d'), 5.99, '30 Rue des Marguerites', 'Lille', 'France', 59000, 'Livrée'),
  (29, 1, STR_TO_DATE('2023-09-14', '%Y-%m-%d'), 4.99, '18 Rue des Violettes', 'Bordeaux', 'France', 33000, 'En cours de préparation'),
  (14, 1, STR_TO_DATE('2023-11-02', '%Y-%m-%d'), 6.99, '7 Rue des Iris', 'Lyon', 'France', 69002, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2023-12-18', '%Y-%m-%d'), 3.99, '25 Rue des Camélias', 'Paris', 'France', 75012, 'En attente de paiement'),
  (19, 1, STR_TO_DATE('2020-05-20', '%Y-%m-%d'), 7.99, '14 Rue des Glycines', 'Nantes', 'France', 44000, 'En cours de préparation'),
  (10, 1, STR_TO_DATE('2020-07-08', '%Y-%m-%d'), 5.99, '9 Rue des Lys', 'Marseille', 'France', 13005, 'En cours de livraison'),
  (27, 1, STR_TO_DATE('2021-09-12', '%Y-%m-%d'), 6.99, '11 Rue des Roses', 'Lyon', 'France', 69003, 'En cours de préparation'),
  (3, 1, STR_TO_DATE('2022-01-30', '%Y-%m-%d'), 8.99, '20 Rue des Orchidées', 'Paris', 'France', 75008, 'En attente de paiement'),
  (35, 1, STR_TO_DATE('2022-03-18', '%Y-%m-%d'), 4.99, '17 Rue des Violettes', 'Toulouse', 'France', 31700, 'En cours de livraison'),
  (22, 1, STR_TO_DATE('2022-05-05', '%Y-%m-%d'), 7.99, '28 Rue des Tulipes', 'Bordeaux', 'France', 33000, 'Livrée'),
  (13, 1, STR_TO_DATE('2023-01-14', '%Y-%m-%d'), 3.99, '6 Rue des Marguerites', 'Marseille', 'France', 13006, 'En cours de préparation'),
  (5, 1, STR_TO_DATE('2023-03-27', '%Y-%m-%d'), 6.99, '3 Rue des Camélias', 'Nantes', 'France', 54000, 'En cours de livraison'),
  (31, 1, STR_TO_DATE('2023-06-10', '%Y-%m-%d'), 5.99, '16 Rue des Pivoines', 'Lille', 'France', 59000, 'En attente de paiement'),
  (42, 1, STR_TO_DATE('2023-08-22', '%Y-%m-%d'), 4.99, '24 Rue des Iris', 'Lyon', 'France', 69004, 'Livrée'),
  (8, 1, STR_TO_DATE('2020-10-15', '%Y-%m-%d'), 6.99, '5 Rue des Jonquilles', 'Marseille', 'France', 13009, 'En cours de préparation'),
  (29, 1, STR_TO_DATE('2021-02-28', '%Y-%m-%d'), 8.99, '18 Rue des Chrysanthèmes', 'Paris', 'France', 75012, 'En cours de livraison'),
  (17, 1, STR_TO_DATE('2021-03-10', '%Y-%m-%d'), 4.99, '12 Rue des Lys', 'Lyon', 'France', 69002, 'Livrée'),
  (7, 1, STR_TO_DATE('2021-06-25', '%Y-%m-%d'), 7.99, '8 Rue des Roses', 'Bordeaux', 'France', 33001, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2022-02-11', '%Y-%m-%d'), 5.99, '15 Rue des Tulipes', 'Marseille', 'France', 13007, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2022-03-30', '%Y-%m-%d'), 3.99, '21 Rue des Orchidées', 'Lille', 'France', 59001, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2022-07-17', '%Y-%m-%d'), 6.99, '7 Rue des Marguerites', 'Lyon', 'France', 69003, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2023-02-28', '%Y-%m-%d'), 8.99, '2 Rue des Camélias', 'Toulouse', 'France', 31700, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2023-03-12', '%Y-%m-%d'), 4.99, '19 Rue des Pivoines', 'Marseille', 'France', 13008, 'En attente de paiement'),
  (41, 1, STR_TO_DATE('2023-07-25', '%Y-%m-%d'), 7.99, '23 Rue des Iris', 'Lyon', 'France', 69004, 'Livrée'),
  (7, 1, STR_TO_DATE('2020-11-15', '%Y-%m-%d'), 5.99, '45 Rue de la Liberté', 'Paris', 'France', 75001, 'En cours de préparation'),
  (22, 1, STR_TO_DATE('2021-03-28', '%Y-%m-%d'), 7.99, '18 Rue du Commerce', 'Lyon', 'France', 69002, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2021-05-18', '%Y-%m-%d'), 3.99, '30 Avenue des Champs-Élysées', 'Bordeaux', 'France', 33000, 'Livrée'),
  (27, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 6.99, '8 Place de la Bastille', 'Nantes', 'France', 59000, 'En cours de préparation'),
  (8, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '5 Boulevard Saint-Michel', 'Marseille', 'France', 13005, 'En cours de livraison'),
  (33, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '12 Quai des Grands 08ustins', 'Toulouse', 'France', 31000, 'En attente de paiement'),
  (18, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '22 Rue de la République', 'Lyon', 'France', 69003, 'En cours de préparation'),
  (42, 1, STR_TO_DATE('2023-03-05', '%Y-%m-%d'), 5.99, '14 Rue du Faubourg Saint-Antoine', 'Paris', 'France', 75012, 'En cours de livraison'),
  (15, 1, STR_TO_DATE('2023-06-22', '%Y-%m-%d'), 3.99, '25 Quai des Chartrons', 'Bordeaux', 'France', 33001, 'Livrée'),
  (38, 1, STR_TO_DATE('2023-09-08', '%Y-%m-%d'), 6.99, '10 Avenue de la Grande Armée', 'Lille', 'France', 59001, 'En attente de paiement'),
  (24, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 5.99, '30 Quai des Chartrons', 'Bordeaux', 'France', 13011, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '25 Avenue de la Grande Armée', 'Paris', 'France', 75001, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '7 Rue de la République', 'Lyon', 'France', 69007, 'En attente de paiement'),
  (2, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '2 Quai des Chartrons', 'Bordeaux', 'France', 33001, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2023-03-05', '%Y-%m-%d'), 5.99, '19 Avenue de la Grande Armée', 'Lille', 'France', 59001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2023-06-22', '%Y-%m-%d'), 3.99, '23 Rue de la République', 'Marseille', 'France', 13012, 'Livrée'),
  (7, 1, STR_TO_DATE('2023-09-08', '%Y-%m-%d'), 6.99, '15 Quai des Chartrons', 'Lyon', 'France', 69004, 'En attente de paiement'),
  (24, 1, STR_TO_DATE('2020-12-20', '%Y-%m-%d'), 8.99, '30 Avenue de la Grande Armée', 'Toulouse', 'France', 31700, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2021-03-05', '%Y-%m-%d'), 4.99, '25 Rue de la République', 'Nantes', 'France', 54000, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2021-05-18', '%Y-%m-%d'), 7.99, '7 Quai des Chartrons', 'Marseille', 'France', 13013, 'Livrée'),
  (2, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 5.99, '2 Avenue de la Grande Armée', 'Paris', 'France', 75001, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '19 Rue de la République', 'Bordeaux', 'France', 33001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '23 Quai des Chartrons', 'Lille', 'France', 59001, 'En attente de paiement'),
  (7, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '15 Avenue de la Grande Armée', 'Marseille', 'France', 13014, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2023-03-05', '%Y-%m-%d'), 5.99, '30 Rue de la République', 'Lyon', 'France', 69004, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2023-06-22', '%Y-%m-%d'), 3.99, '25 Quai des Chartrons', 'Bordeaux', 'France', 33001, 'Livrée'),
  (12, 1, STR_TO_DATE('2023-09-08', '%Y-%m-%d'), 6.99, '7 Avenue de la Grande Armée', 'Lille', 'France', 59001, 'En attente de paiement'),
  (2, 1, STR_TO_DATE('2020-12-20', '%Y-%m-%d'), 8.99, '2 Rue de la République', 'Marseille', 'France', 13015, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2021-03-05', '%Y-%m-%d'), 4.99, '19 Quai des Chartrons', 'Paris', 'France', 75001, 'En cours de livraison'),
  (24, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 5.99, '30 Quai des Chartrons', 'Bordeaux', 'France', 13011, 'En cours de préparation'),
  (38, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '25 Avenue de la Grande Armée', 'Paris', 'France', 75001, 'En cours de livraison'),
  (12, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '7 Rue de la République', 'Lyon', 'France', 69007, 'En attente de paiement'),
  (2, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '2 Quai des Chartrons', 'Bordeaux', 'France', 33001, 'En cours de préparation'),
  ...
  (2, 1, STR_TO_DATE('2020-12-20', '%Y-%m-%d'), 8.99, '2 Rue de la République', 'Marseille', 'France', 13015, 'En cours de préparation'),
  (26, 1, STR_TO_DATE('2021-03-05', '%Y-%m-%d'), 4.99, '19 Quai des Chartrons', 'Paris', 'France', 75001, 'En cours de livraison'),
  (41, 1, STR_TO_DATE('2021-05-18', '%Y-%m-%d'), 7.99, '23 Avenue de la Grande Armée', 'Bordeaux', 'France', 33000, 'Livrée'),
  (7, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 5.99, '15 Rue de la République', 'Marseille', 'France', 13016, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '30 Quai des Chartrons', 'Lyon', 'France', 69004, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '25 Avenue de la Grande Armée', 'Nantes', 'France', 54000, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '7 Rue de la République', 'Marseille', 'France', 13017, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2023-03-05', '%Y-%m-%d'), 5.99, '2 Quai des Chartrons', 'Bordeaux', 'France', 33001, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2023-06-22', '%Y-%m-%d'), 3.99, '19 Avenue de la Grande Armée', 'Lille', 'France', 59001, 'Livrée'),
  (41, 1, STR_TO_DATE('2023-09-08', '%Y-%m-%d'), 6.99, '23 Rue de la République', 'Marseille', 'France', 13018, 'En attente de paiement'),
  (7, 1, STR_TO_DATE('2020-12-20', '%Y-%m-%d'), 8.99, '15 Quai des Chartrons', 'Lyon', 'France', 69004, 'En cours de préparation'),
  (24, 1, STR_TO_DATE('2021-03-05', '%Y-%m-%d'), 4.99, '30 Avenue de la Grande Armée', 'Nantes', 'France', 54000, 'En cours de livraison'),
  (38, 1, STR_TO_DATE('2021-05-18', '%Y-%m-%d'), 7.99, '25 Rue de la République', 'Marseille', 'France', 13019, 'Livrée'),
  (12, 1, STR_TO_DATE('2021-08-02', '%Y-%m-%d'), 5.99, '7 Quai des Chartrons', 'Paris', 'France', 33000, 'En cours de préparation'),
  (2, 1, STR_TO_DATE('2022-02-15', '%Y-%m-%d'), 8.99, '2 Avenue de la Grande Armée', 'Bordeaux', 'France', 59001, 'En cours de livraison'),
  (26, 1, STR_TO_DATE('2022-07-01', '%Y-%m-%d'), 4.99, '19 Rue de la République', 'Marseille', 'France', 13020, 'En attente de paiement'),
  (41, 1, STR_TO_DATE('2022-10-18', '%Y-%m-%d'), 7.99, '23 Quai des Chartrons', 'Lille', 'France', 59001, 'En cours de préparation'),
  (7, 1, STR_TO_DATE('2023-03-05', '%Y-%m-%d'), 5.99, '15 Avenue de la Grande Armée', 'Nantes', 'France', 54000, 'En cours de livraison'),
  (24, 1, STR_TO_DATE('2023-06-22', '%Y-%m-%d'), 3.99, '30 Rue de la République', 'Toulouse', 'France', 33001, 'Livrée'),
  (38, 1, STR_TO_DATE('2023-09-08', '%Y-%m-%d'), 6.99, '25 Quai des Chartrons', 'Marseille', 'France', 13021, 'En attente de paiement'),
  (12, 1, STR_TO_DATE('2020-12-20', '%Y-%m-%d'), 8.99, '7 Avenue de la Grande Armée', 'Lyon', 'France', 69004, 'En cours de préparation');
